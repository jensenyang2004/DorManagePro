...
const FacilityReservation = () => {
  ...
  const getAllFacility = async () => {
    try {
      const response = await axios.get('http://localhost:8888/api/dorm/dorm_facility');
  ...
  const getFacilitySchedule = async (facilityId) => {
    try {
      const response = await axios.get('http://localhost:8888/api/dorm/facility_schedule', {
